# start-python3-tablestore 帮助文档

<p align="center" class="flex justify-center">
    <a href="https://www.serverless-devs.com" class="ml-1">
    <img src="http://editor.devsapp.cn/icon?package=start-python3-tablestore&type=packageType">
  </a>
  <a href="http://www.devsapp.cn/details.html?name=start-python3-tablestore" class="ml-1">
    <img src="http://editor.devsapp.cn/icon?package=start-python3-tablestore&type=packageVersion">
  </a>
  <a href="http://www.devsapp.cn/details.html?name=start-python3-tablestore" class="ml-1">
    <img src="http://editor.devsapp.cn/icon?package=start-python3-tablestore&type=packageDownload">
  </a>
</p>
...
- :fire: 通过 [Serverless 应用中心](https://fcnext.console.aliyun.com/applications/create?template=start-python3-tablestore) ，
[![Deploy with Severless Devs](https://img.alicdn.com/imgextra/i1/O1CN01w5RFbX1v45s8TIXPz_!!6000000006118-55-tps-95-28.svg)](https://fcnext.console.aliyun.com/applications/create?template=start-python3-tablestore)  该应用。 

</appcenter>

- 通过 [Serverless Devs Cli](https://www.serverless-devs.com/serverless-devs/install) 进行部署：
    - [安装 Serverless Devs Cli 开发者工具](https://www.serverless-devs.com/serverless-devs/install) ，并进行[授权信息配置](https://www.serverless-devs.com/fc/config) ；
    - 初始化项目：`s init start-python3-tablestore -d start-python3-tablestore`   
    - 进入项目，并进行项目部署：`cd start-python3-tablestore && s deploy -y`
...
| ------------ | -------- | -------- | -------------------------------------------------------- | ------------------ |
| serviceName  | String   | 选填     | start-python3-tablestore                                | 函数服务名称名     |
| functionName | String   | 选填     | start-python3-tablestore                                | 函数名称           |
