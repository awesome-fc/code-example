# mns-topic-trigger-php 帮助文档

<p align="center" class="flex justify-center">
    <a href="https://www.serverless-devs.com" class="ml-1">
    <img src="http://editor.devsapp.cn/icon?package=mns-topic-trigger-php&type=packageType">
  </a>
  <a href="http://www.devsapp.cn/details.html?name=mns-topic-trigger-php" class="ml-1">
    <img src="http://editor.devsapp.cn/icon?package=mns-topic-trigger-php&type=packageVersion">
  </a>
  <a href="http://www.devsapp.cn/details.html?name=mns-topic-trigger-php" class="ml-1">
    <img src="http://editor.devsapp.cn/icon?package=mns-topic-trigger-php&type=packageDownload">
  </a>
</p>

<description>

快速部署一个 php 7.2 的 Event 类型的 MNS Topic trigger 函数到阿里云函数计算。
...
- [ :smiley_cat:  源代码](https://github.com/devsapp/start-fc/blob/main/event-function/mns-topic-trigger-php)
- 为了能够成功部署本样例代码，您在部署过程中需要提供以下参数：
    ...
    - 函数名 (function name): 您需要给您的函数计算函数进行命名，函数名称，只能包含字母、数字、下划线和中划线。不能以数字、中划线开头。长度在 1-64 之间。默认值为 mns-topic-trigger-php。
...
-  :fire:  通过 [Serverless 应用中心](https://fcnext.console.aliyun.com/applications/create?template=mns-topic-trigger-php) ，
[![Deploy with Severless Devs](https://img.alicdn.com/imgextra/i1/O1CN01w5RFbX1v45s8TIXPz_!!6000000006118-55-tps-95-28.svg)](https://fcnext.console.aliyun.com/applications/create?template=mns-topic-trigger-php)  该应用。 

</appcenter>

- 通过 [Serverless Devs Cli](https://www.serverless-devs.com/serverless-devs/install) 进行部署：
    - [安装 Serverless Devs Cli 开发者工具](https://www.serverless-devs.com/serverless-devs/install) ，并进行[授权信息配置](https://www.serverless-devs.com/fc/config) ；
    - 初始化项目：`s init mns-topic-trigger-php -d mns-topic-trigger-php` 
    - 填入在以上模块介绍的参数
    - 进入项目，并进行项目部署：`cd mns-topic-trigger-php && s deploy -y`
...
- 本地调试
  ...
  - 调用函数时收到的响应如下所示:
    ...
    2022-07-20T07:58:17.591Z f6c84568-6251-44cf-8f2d-715exxxxxxxx [INFO] MessageBody is: mock mns message ,MessageID is: 3405CA51807661353B3xxxxxxxx
    ...
    FC Invoke Result:
    MessageBody is: mock mns message ,MessageID is: 3405CA51807661353B3xxxxxxxx
...
- 端对端测试
  ...
  - 函数日志内容如下所示:
    ```bash
    2022-08-18 20:28:34FC Invoke Start RequestId: E4E46B87-1B02-590D-B54D-481E02A5xxxx
    2022-08-18 20:28:342022-08-18 20:28:34 E4E46B87-1B02-590D-B54D-481E02A5xxxx [INFO] MessageBody is: mock mns message ,MessageID is: AB06C9B48076416703525BF0E47E7468
    2022-08-18 20:28:34\nFC Invoke End RequestId: E4E46B87-1B02-590D-B54D-481E02A5xxxx
    ```
</deploy>
