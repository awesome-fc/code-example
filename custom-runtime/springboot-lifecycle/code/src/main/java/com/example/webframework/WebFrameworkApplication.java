...
public class WebFrameworkApplication {
    ...
    public ResponseEntity<Map<String, String>> listHeaders(
        ...
        public ResponseEntity<String> initialize(@RequestHeader Map<String, String> headers) {
            String rid = headers.get("x-fc-request-id");
            System.out.println("FC Initialize Start RequestId:"+rid);
            //do your things
            System.out.println("FC Initialize End RequestId:"+rid);
            return new ResponseEntity<>("OK", HttpStatus.OK);
        };
        @GetMapping("/pre-freeze")
        public ResponseEntity<String> prefreeze(@RequestHeader Map<String, String> headers) {
            String rid = headers.get("x-fc-request-id");
            System.out.println("FC prefreeze Start RequestId:"+rid);
            //do your things
            System.out.println("FC prefreeze End RequestId:"+rid);
            return new ResponseEntity<>("OK", HttpStatus.OK);
        };
        @GetMapping("/pre-stop")
        public ResponseEntity<String> prestop(@RequestHeader Map<String, String> headers) {
            String rid = headers.get("x-fc-request-id");
            System.out.println("FC prestop Start RequestId:"+rid);
            //do your things
            System.out.println("FC prestop End RequestId:"+rid);
            return new ResponseEntity<>("OK", HttpStatus.OK);
        };
