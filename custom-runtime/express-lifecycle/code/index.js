...
app.post('/initialize', function(req, res) {
    var rid = req.get("x-fc-request-id");
...
app.get('/pre-freeze', function(req, res) {
    var rid = req.get("x-fc-request-id");
    console.log("FC PreFreeze Start RequestId: " + rid);
    // do your things
    console.log("FC PreFreeze End RequestId: " + rid);
    res.send('ok');
});

app.get('/pre-stop', function(req, res) {
    var rid = req.get("x-fc-request-id");
    console.log("FC PreStop Start RequestId: " + rid);
    // do your things
    console.log("FC PreStop End RequestId: " + rid);
    res.send('ok');
});
